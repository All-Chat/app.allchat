            ...
            <div className="flex flex-col gap-2 w-full sm:w-auto"> 
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto"> 
                ...
                <div className="flex gap-2 flex-wrap items-center"> 
                  ...
                  {/* ✅ DISABLED IF hiddenActions.includes("brief") */} 
                  <button  
                    onClick={() => setIsBriefOpen(true)}  
                    disabled={hiddenActions.includes("brief")}
                    className={`px-4 py-2 border rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-colors shrink-0 ${
                  ...
                  {/* ✅ DISABLED IF hiddenActions.includes("loadSheet") */} 
                  <button  
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-colors shrink-0 disabled:opacity-60 disabled:cursor-not-allowed ${ 
                      hiddenActions.includes("loadSheet") || sheetUrl ? "bg-slate-200 text-slate-500" : "bg-indigo-500 text-white hover:bg-indigo-600" 
                    }`} 
                  > 
                  ...
                  {/* ✅ DISABLED IF hiddenActions.includes("generateReport") */} 
                  <button  
                    ...
                    className={`px-4 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-colors shrink-0 disabled:opacity-60 disabled:cursor-not-allowed ${ 
                      hiddenActions.includes("generateReport") || standaloneSheetUrl ? "bg-slate-200 text-slate-500" : "bg-purple-500 text-white hover:bg-purple-600" 
                    }`} 
                  > 
                  ...
                  {/* ✅ DISABLED IF hiddenActions.includes("downloadExcel") */} 
                  <button  
